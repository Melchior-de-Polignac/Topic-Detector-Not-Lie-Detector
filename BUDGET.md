...
| 2026-07-12 | **Session A part 2 (T1.6 + T1.4)** — fresh A40 `w793zityg83wcv`; deps + 14B download + emission-AUROC construct validity + status-contrast probe D (ships 2×263MB LoRA adapters). ESTIMATE (before run). | RunPod A40 ~$0.44/hr, ~1.5–2h | 0.7–1 | _pending_ | ~10–10.5 (proj) |
